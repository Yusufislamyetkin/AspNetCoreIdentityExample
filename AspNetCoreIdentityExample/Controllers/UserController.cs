    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> PasswordReset(ResetPasswordViewModel model)
        {
            ...
            if (user != null)
            {
                ...
                smp.Credentials = new NetworkCredential("devayyil@gmail.com", "23asjDnsd2"); //Kendi mailin ve mail yollama kodun 
                // Kodunu google hesabının güvenlik bölümünden uygulama şifreleri bölümünden alabilirsin.
                smp.Port = 587;
